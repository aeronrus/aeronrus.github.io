...
const Sort : React.FC<SortPops> = React.memo(({sortId})=>{
...
const list = sortCategory.map((item, index:any)=>(<li onClick={()=>{onClickSort(index)}} key={index} className={index===sortId?'active':''}>{item}</li>))
